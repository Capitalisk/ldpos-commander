...
const transfer = async function (client, minFees) {
  ...
  const fee =
    (await this.promptInput(
      `Fee (Default: ${minFees.minTransactionFees.transfer})`
...
const vote = async function (client, minFees) {
  ...
  const fee =
    (await this.promptInput(
      `Fee (Default: ${minFees.minTransactionFees.vote})`
...
const unvote = async function (client, minFees) {
  ...
  const fee =
    (await this.promptInput(
      `Fee (Default: ${minFees.minTransactionFees.unvote})`
...
const multisigTransfer = async function (client, minFees) {
  const recipientAddress = await this.promptInput('Address of the recipient:');
  if (recipientAddress === '') throw new Error('You should provide an address');
...
// const verifyTransaction = async function (client, minFees) {
...
const registerMultisigWallet = async function (client, minFees) {
  ...
  const fee =
    (await this.promptInput(
      `Fee (Default: ${minFees.minTransactionFees.registerMultisigWallet})`
...
const registerMultisigDetails = async function (client, minFees) {
  ...
  const fee =
    (await this.promptInput(
      `Fee (Default: ${minFees.minTransactionFees.registerMultisigDetails})`
...
const registerSigDetails = async function (client, minFees) {
  ...
  const fee =
    (await this.promptInput(
      `Fee (Default: (Default: ${minFees.minTransactionFees.registerSigDetails})`
...
const registerForgingDetails = async function (client, minFees) {
  ...
  const fee =
    (await this.promptInput(
      `Fee (Default: ${minFees.minTransactionFees.registerForgingDetails})`
...
const pendingTransactions = async function (client, minFees) {
