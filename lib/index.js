...
class CmdInterface {
  ...
  getCommands() {
    ...
    return {
      ...
      wallet: {
        balance: async () => await this.actions.getBalance(),
        address: async () => this.ldposAction('getWalletAddress', 'wallet address:'),
        generate: async () => this.ldposAction('generateWallet', 'generated wallet:'),
        get: async () => await this.actions.getWallet(),
        getMultisigWalletMembers: async () => await this.actions.getMultisigWalletMembers(),
        publicKey: async () => this.ldposAction('sigPublicKey', 'public key:'),
        multisigPublicKey: async () => this.ldposAction('multisigPublicKey', 'public key:'),
      },
      config: {
      ...
      transaction: {
        ...
        verify: async () => await this.actions.verifyTransaction(),
  ...
  intertactiveLog() {
    ...
    console.log('  wallet address                                 Get address of signed in wallet');
    console.log('  wallet generate                                Generates a wallet');
    console.log('  wallet get                                     Get wallet');
    console.log('  wallet get-multisig-waller-members             Get wallet members');
    console.log('  wallet public-key                              Get sig wallet public key');
    console.log('  wallet multisig-public-key                     Get multisig wallet public key');
    console.log('  wallet get-multisig-waller-members             Get wallet members');
  ...
  commandLog() {
    ...
    console.log('     address                                     Get address of signed in wallet');
    console.log('     generate                                    Generates a wallet');
    console.log('     get                                         Get wallet');
    console.log('     get-multisig-wallet-members                 Get wallet members');
    console.log('     public-key                                  Get sig wallet public key');
    console.log('     multisig-public-key                         Get multisig wallet public key');
