...
const passphrasePrompt = async () => await promptInput('Passphrase:', true);
...
const errorLog = (errorMsg) => {
  ...
  console.log(
    '\x1b[1m\x1b[31mPlease post an issue in the repo: https://github.com/Leasehold/ldpos-commander'
  );
  process.exit();
};
